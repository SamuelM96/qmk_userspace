...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_NAV] = LAYOUT(
            ...
            KC_CAPS,    OSM_RALT,   CW_TOGG,    KC_SPC,     SNAKECASE,          KC_DEL,       KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,
	...
	[_SYM] = LAYOUT(
            ...
            UK_LCBR,    UK_LPRN,    UK_EQL,     UK_RPRN,    UK_RCBR,            UK_PERC,    UK_TILD,    UK_DQUO,   UK_QUOT,    UK_EXLM,
            UK_BSLS,    UK_ASTR,    UK_COLN,    UK_PLUS,    UK_UNDS,            UK_DLR,     UK_AMPR,    UK_GRV,    UK_PIPE,    UK_PND,
