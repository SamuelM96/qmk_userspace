...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYM] = LAYOUT(
      ...
      KC_TRNS, UK_BSLS, UK_ASTR, UK_COLN, UK_PLUS, UK_UNDS,                        UK_AMPR, UK_TILD, UK_QUES, UK_PIPE, UK_PND,  KC_TRNS,
                                          KC_TRNS, KC_TRNS, FUNC,            KC_TRNS,KC_BSPC, KC_TRNS
  ),
    ...
    [_MEDIA] = LAYOUT(
      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                    KC_NO,   KC_MPRV, KC_BRID, KC_BRIU, KC_MNXT, KC_NO,
    ...
    [_GAME] = LAYOUT(
      ...
      KC_I,  KC_LSFT, KC_A, KC_S, KC_D, KC_F,                                    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
